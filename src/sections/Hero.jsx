...
export default function Hero() {
  ...
  const handleVideoError = (id) =>
    setBrokenVideos((p) => (p.includes(id) ? p : [...p, id]));
    ...
    <div className="hero-wrap">
      ...
      <div className="hero-top-row">
        ...
        <div className="hero-copy hero-reveal hero-reveal-1">
          ...
          <h1
            className="hero-name hero-name-main hero-name-editorial"
            ref={nameRef}
          >
          ...
          <p className="hero-role-line hero-role-editorial">
            Social-first ideas, campaign direction,
            <br />
          ...
          <div className="hero-actions hero-actions-editorial">
            <a
              href="#selected-works"
              className="btn btn-primary hero-btn hero-btn-editorial"
            >
              <span>View Work</span>
      ...
      <div className="hero-mobile-row">
        <div className="hero-mobile-editorial-header">
          ...
          <h1
            className="hero-name hero-name-main hero-name-mobile-editorial"
            ref={nameRef}
          >
            <span className="hero-name-line hero-name-first">Abhishek</span>
            <span className="hero-name-line hero-name-last">De</span>
        ...
        <div className="m-stage">
          ...
          <button
            type="button"
            className="m-chip m-chip-brands"
          ...
          <button
            type="button"
            className="m-chip m-chip-events"
        ...
        <div className="hero-stats-mobile-editorial">
          ...
          <div className="hero-stat-pill">
            <span className="hsp-num">3.9M</span>
            <span className="hsp-label">Views</span>
          </div>
          <div className="hero-stat-divider" />
          <div className="hero-stat-pill">
            <span className="hsp-num">50+</span>
        ...
        >
          <div
            className={`brand-ticker-track ${
              tickerPaused ? "brand-ticker-paused" : ""
            }`}
          >
            {tripled.map((item, i) => (
              <button
                ...
                className={`brand-ticker-item ${
                  selectedItem.id === item.id ? "brand-ticker-active" : ""
                }`}
                onClick={() => openItem(item)}
              >
                {item.logo ? (
        ...
        <div id="hero-tray-area">
          {openTray === "brands" && (
            <div className="m-tray">
              <p className="m-tray-label">
                Brands & Agencies — tap to see work
              </p>
              <div className="m-tray-grid">
                {brandCloud.map((item) => (
                  <button
                    key={item.id}
                    type="button"
                    className={`m-tray-item ${
                      selectedItem.id === item.id ? "m-tray-item-active" : ""
                    }`}
                    onClick={() => openItem(item)}
                  >
                    {item.logo && (
